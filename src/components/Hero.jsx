...
const Hero = () => {
  ...
  return (
    <div className="relative h-screen text-white overflow-hidden">
      ...
      {/* Content */}
      <div className="absolute z-10 flex flex-col justify-end items-start bottom-10 md:pl-10 md:ml-40 p-10">
        <h1 className="text-5xl font-bold leading-tight mb-4 w-3/5">
          Welcome to Timbu Shopper Crafting
        </h1>
